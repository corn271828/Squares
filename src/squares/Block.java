...
public abstract class Block {
    ...
    public static class BlasterBlock extends Block {
        protected Direction direction;
        protected int period; //In units of timestamp
        protected int blastSpeed; //pixels per timestamp
        ...
        public static class Blast {
            ...
            @Override
            protected Blast clone() throws CloneNotSupportedException {
    ...
    public static class CannonBlock extends Block {
        protected int period; //In units of timestamp
        protected int cannonballSpeed; //pixels per timestamp
        protected int delay;
        ...
        public static class Cannonball extends Block.BlasterBlock.Blast {
            ...
            protected double angle; // angle in radians; think reflected unit circle
